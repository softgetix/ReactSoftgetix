  ...
  return (
    ...
    <Template>
        ...
        <div className="container">
            ...
            <div className="col-md-6 col-lg-6 text-center">
                <img src="images/fence-erp.png" alt="" className="service_img" width="90%"/>
            </div>
            </div>
            ...
            <div className="col-md-6 col-lg-6 text-center">
                <img src="images/dashboard.png" alt="" className="service_img" width="90%"/>
            </div>
            </div>
            <div className="row align-items-center mt-5 pt-3 pb-3">
            <div className="col-md-6 col-xl-6 order-md-2">
            ...
            <div className="col-md-6 col-lg-6 text-center">
                <img src="images/document-management.png" alt="" className="service_img" width="90%"/>
            </div>
            </div>
            <div className="row align-items-center mt-5 pt-3 pb-3">
            <div className="col-md-6 col-xl-6">
            ...
            <div className="col-md-6 col-lg-6 text-center">
                <img src="images/crypto-exchange.png" alt="" className="service_img" width="90%"/>
            </div>
            </div>  
        </div>
        </section>
