  ...
  return (
    <>
      <Template>
                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-sm-10 col-md-6 order-md-1 mt-5">
                            ...
                            <a href="#" className="btn free_Quote_btn btn-lg mt-3"> <span> Talk To Sales </span> </a>
                        </div>
                    </div>
                </div>
                </div>
        ...
        <section className="short-contact_us mt-0">
		   <div className="container">
		      <div className="row">
		         <div className="col-lg-2"></div>
		         <div className="col-lg-8 text-center">
		            <h1><b>ARE YOU READY TO START ?</b></h1>
		            <a href="/getFreeQuote" className="btn free_Quote_btn btn-lg mt-3" >Talk To Sales</a>
		         </div>
		         <div className="col-lg-2"></div>
		      </div>
		   </div>
