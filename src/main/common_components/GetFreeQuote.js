                                 ...
                                 <div className="row">
                                    <div className="col-md-6">
                                       <div className="form-group">
                                          ...
                                          <input type="text" className="form-control" name="name" value={name} onChange={(e) => setName(e.target.value)} id="name"  size="40" placeholder="Enter your name" required/>
                                       </div>
                                    </div>
                                    <div className="col-md-6">
                                       <div className="form-group">
                                    ...
                                    <div className="col-md-6">
                                       <div className="form-group">
                                          ...
                                          <input type="tel" className="form-control" name="mobile" value={mobile} onChange={(e) => setMobile(e.target.value)} id="phone"  size="40" placeholder="Enter your contact no." required/>
                                       </div>
                                    </div>
                                    <div className="col-md-6">
                                       <div className="form-group">
                                    ...
                                    <div className="col-md-12">
                                       <div className="form-group">
                                          ...
                                          <textarea name="comment" value={comment} onChange={(e) => setComment(e.target.value)} className="form-control" id="message" cols="30" rows="4" placeholder="Type your message here.." required></textarea>
                                       </div>
                                    </div>
                                    <div className="col-md-12">
                                       <div className="form-group">
                              ...
                              <div className="row">
                              	<div className="contact-details">
                                    ...
                                    <ul className="socials-icons">
	                                    <li>
	                                        <a href="#" target="blank"><i className="fa fa-facebook fa-brands"></i></a>
	                                    </li>
	                                    <li>
	                                        <a href="#" target="blank"><i className="fa fa-linkedin fa-brands"></i></a>
	                                    </li>
	                                    <li>
	                                        <a href="#" target="blank"><i className="fa fa-twitter fa-brands"></i></a>
	                                    </li>
	                                    <li>
	                                        <a href="#" target="_blank"><i className="fa fa-instagram fa-brands"></i> </a>
	                                    </li>
                                    </ul>
                                </div>
                              </div>
